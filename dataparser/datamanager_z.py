...
@dataclass
class myDataManagerConfig(InstantiateConfig):
    ...
    dataparser: myDataParserConfig = myDataParserConfig()
    ...
    # load_features: tyro.conf.Suppress[bool] = False
...
class myDataManager(DataManager):
    ...
    @cached_property
    def fixed_indices_eval_dataloader(self) -> myEvalDataLoader:
        eval_dataparser_outputs = self.dataparser.get_dataparser_outputs(split='val')

        return myEvalDataLoader(
    ...
    def all_indices_eval_dataloader(self, generate_ring_view: bool, video_ids: Optional[Set[int]],
                                    ...
                                    pos_shift: Optional[torch.Tensor]) -> myEvalDataLoader:
        eval_dataparser_outputs = self.dataparser.get_dataparser_outputs(split='val')
